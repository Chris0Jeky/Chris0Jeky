...
Generated for **Chris0Jeky** from public GitHub data at `2026-08-24T11:46:39.526Z`.
...
- **Stats:** 0 stars · 0 forks · 182 open issues/PRs
...
- [CI](https://github.com/Chris0Jeky/Taskdeck/actions/runs/32723580518) — observed
...
- **Stats:** 0 stars · 0 forks · 6 open issues/PRs
...
- [CI](https://github.com/Chris0Jeky/CommitAtlas/actions/runs/32722934838) — observed
...
- **Lifecycle:** Active
- **CI:** Pending (`ci.yml`)
- **Description:** Free, open\-source Windows mouse jiggler and keep\-awake utility\. Native C\+\+20/Win32, ~500 KB, no runtime, no telemetry\. Bounded motion modes, Windows power requests, and safeguards that pause on real input, lock, battery, or full\-screen apps\.
- **Stats:** 0 stars · 0 forks · 18 open issues/PRs
- **Release:** v0\.2\.0 (`v0.2.0`)

### Actions

- [Source](https://github.com/Chris0Jeky/IdleHarbor) — observed
- [CI](https://github.com/Chris0Jeky/IdleHarbor/actions/runs/32723509791) — observed
...
- **Stats:** 0 stars · 0 forks · 43 open issues/PRs
